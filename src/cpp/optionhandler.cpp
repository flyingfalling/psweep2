...
void parsedoption::enumerate()
  ...
  parsedoption::parsedoption( const std::vector<std::string>& toparse )
  {
    if(toparse.size() < 1)
      {
  ...
  size_t parsedoption::get_nargs()
  {
    return parsedargs.size();
  }

  std::string parsedoption::get_arg( const size_t& argn )
  {
  ...
  float64_t parsedoption::argn_as_float64( const size_t& argn )
  {
  ...
  float64_t parsedoption::argn_as_int64( const size_t& argn )
  {
    std::string argval = get_arg( argn );
...
parsedoption optlist::get_opt( const std::string& optname )
  {
  ...
  std::vector<parsedoption>  optlist::doparse( const std::vector<std::string>& args )
  {
  ...
  std::vector< std::string >  optlist::strvect_from_charptr_array( const int& argc,  char* argv[] )
  {
  ...
  //optlist( const std::vector<std::string>& args )
   optlist::optlist( const int& argc, char* argv[] )
  {
  ...
  std::vector< std::vector< std::string> >  optlist::get_opt_args( const std::string& optname )
  {
    std::vector<size_t> locs = get_matches( optname, parsedopts );
  ...
  std::vector<size_t>  optlist::get_matches( const std::string& argname, std::vector< parsedoption >& optns )
  {
