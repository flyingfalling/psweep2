...
void grid_state::search_grid( optlist& opts,
  ...
  void grid_state::search_grid( const std::vector<std::string>& varnames,
  ...
  void grid_state::parseopts( optlist& opts)
  {
  ...
  void grid_state::parse_gridfile( const std::string& gridfname )
  {
